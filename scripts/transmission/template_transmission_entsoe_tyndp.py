...
def _entsoe_ntcs(locations, tyndp_scenarios, scenario, grid, year, ntc_limit):
    ...
    sliced_scenarios = tyndp_scenarios[
        ...
        & (
            tyndp_scenarios["Climate Year"] == 2007
        )  # not entirely sure what this is, but there is the choice between 1982, 1984, and 2007
    ]
    if grid.lower() == "reference":
        sliced_scenarios = sliced_scenarios[sliced_scenarios.Case.str.lower() == "reference grid"]
