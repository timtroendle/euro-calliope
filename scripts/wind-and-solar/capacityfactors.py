...
import xarray as xr
from eurocalliopelib.geo import EPSG3035, area_weighted_time_series, convert_old_style_capacity_factor_time_series
...
def capacityfactors(
    ...
    capacityfactors = area_weighted_time_series(
        shapes=locations, spatiotemporal=ts, gridcell_overlap_threshold=gridcell_overlap_threshold
    )
