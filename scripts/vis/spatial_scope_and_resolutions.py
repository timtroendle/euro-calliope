...
def _plot_text(national, regional, ax):
    ...
    ax.set_ylim(0, 1)
    ax.text(
        x=0.0, y=0.65, fontdict={"fontweight": "semibold", "va": "top", "ha": "left"}, s="Euro-Calliope's resolutions:"
    )
    ax.text(
        x=0.03,
        y=0.63,
    ...
    ax.text(x=0.0, y=0.15, fontdict={"va": "top", "size": 4}, s="Source: GADM, NUTS © EuroGeographics.")
