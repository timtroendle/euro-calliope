...
@pytest.mark.parametrize("eu_country_code,iso3166", [("uk", "GBR"), ("el", "GRC"), ("de", "DEU")])
def test_eu_country_code_conversion(eu_country_code, iso3166):
    assert eu_country_code_to_iso3(eu_country_code) == iso3166


@pytest.mark.parametrize(
    "input,alpha3", [("uk", "GBR"), ("el", "GRC"), ("de", "DEU"), ("Germany", "DEU"), ("Greece", "GRC")]
)
...
@pytest.mark.parametrize(
    "input,alpha2", [("uk", "GB"), ("el", "GR"), ("de", "DE"), ("Germany", "DE"), ("Greece", "GR")]
)
...
@pytest.mark.parametrize(
    "input,alpha2", [("uk", "UK"), ("el", "EL"), ("de", "DE"), ("Germany", "DE"), ("Greece", "EL")]
)
